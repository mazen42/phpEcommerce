...
<body>
			...
			<div class="col-md-6">
				...
				<form method="POST">
					<div class="mb-3">
						...
						<input type="text" id="namedetails" disabled name="name"
							value="<?php echo $row["productName"]; ?>" class="form-control"
							placeholder="Enter product name">
					</div>
					<div class="mb-3">
						<label class="form-label">Author</label>
						<input type="text" id="Authordetails" disabled name="author"
							value="<?php echo $row["author"]; ?>" class="form-control" placeholder="Enter product name">
					</div>
					<div class="mb-3">
					...
					<div class="mb-3">
						...
						<input type="number" id="pricedetails" disabled name="price"
							value="<?php echo $row["PRICE"]; ?>" class="form-control" placeholder="$0.00">
					</div>
					<div class="mb-3">
					...
					<div class="mb-3">
						...
						<input type="number" id="price100details" disabled name="price100"
							value="<?= $row["PRICE100"] ?>" class="form-control" placeholder="$0.00">
					</div>
					<div class="mb-3">
	...
	<script>
		let data = '<?= json_encode($Categories_rows) ?>'
		console.log(data)
	</script>
	<script src="https://code.jquery.com/jquery-3.7.1.min.js"></script>
	<script src="js/ProductDeals.js"></script>
</body>
